...
namespace KyoshinMonitorLib
{
	...
	public static class Extensions
	{
		...
		public static async Task<ImageAnalysisResult[]> ParseIntensityFromParameterAsync(this ObservationPoint[] points, DateTime datetime, bool isBehole = false)
		...
		/// <param name="isBehole">地中の情報を取得するかどうか</param>
		/// <returns>震度情報が追加された観測点情報の配列</returns>
		public static async Task<ImageAnalysisResult[]> ParseIntensityFromParameterAsync(this ImageAnalysisResult[] points, DateTime datetime, bool isBehole = false)
		{
		...
		/// <returns>震度情報が追加された観測点情報の配列</returns>
		public static ImageAnalysisResult[] ParseIntensityFromImage(this ImageAnalysisResult[] points, Bitmap bitmap)
		{
